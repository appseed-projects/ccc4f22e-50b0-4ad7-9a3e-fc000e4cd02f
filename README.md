...
> 🚀 Built with [Adminator Generator](https://appseed.us/generator/adminator/), timestamp `2022-08-12 21:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ccc4f22e-50b0-4ad7-9a3e-fc000e4cd02f.git
$ cd ccc4f22e-50b0-4ad7-9a3e-fc000e4cd02f
```
